...
export BLOB="$(didc encode --format blob "(1696190804123423684 : int)")"
quill sns  --canister-ids-file ./sns_canister_ids.json  --pem-file $PEM_FILE  make-proposal $DEVELOPER_NEURON_ID --proposal "(
    record { 
        ...
        More information about the details of this upgrade to the World Protocol can be found here: 
        https://docs.boomdao.xyz/release-notes#september-30-2023\";
        action = opt variant {
