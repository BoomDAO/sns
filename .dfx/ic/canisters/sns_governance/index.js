...
export const canisterId = process.env.SNS_GOVERNANCE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sns_governance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sns_governance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sns_governance.did.js")._SERVICE>}
 */
