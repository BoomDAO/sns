...
1. Upgrade WorldHub canister with the latest UserNode WASM, to support World's refactoring for better handling of actions and configs. " \
  --url "https://boomdao.xyz"  \
  --target-canister-id "j362g-ziaaa-aaaap-abf6a-cai" \
  --wasm-path "./proposals/12.2023/WorldHub.wasm" \
