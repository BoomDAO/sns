...
quill sns --canister-ids-file ./sns_canister_ids.json --pem-file $PEM_FILE make-proposal --proposal "(
    record {
        title = \"Transfer 600,000 BOOM to ICP/BOOM Pool on Sonic Dex\";
        url = \"https://boomdao.xyz/\";
        summary = \"This is the second of 2 proposals which add liquidity to the ICP/BOOM pool on SONIC DEX (https://data.sonic.ooo/pools/ryjl3-tyaaa-aaaaa-aaaba-cai:vtrom-gqaaa-aaaaq-aabia-cai)
...
Simultaneously, @sonic_ooo will tweet to verify these proposals. If these proposals are approved, Sonic Dex will add the funds to the liquidity pool.\";
        action = opt variant {
            TransferSnsTreasuryFunds = record {
                ...
                memo = null;
                amount_e8s = 60000000000000 : nat64;
            }
        };
    }
