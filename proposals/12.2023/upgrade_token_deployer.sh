...
1. Added official ICRC ledger support to Token Deployer.
2. Added ledger wasms management in Token Deployer to support future upgrades of Token canisters."  \
  --url "https://boomdao.xyz"  \
  --target-canister-id "jv4xo-cyaaa-aaaap-abf7a-cai" \
  --wasm-path "./proposals/12.2023/token_deployer.wasm.gz" \
