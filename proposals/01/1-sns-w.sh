...
ic-admin  \
   ...
   --added-principals "qf6cz-ciaaa-aaaag-abtsq-cai"  \
   --proposer "3640404658249905115" \
   --proposal-title "Enable principal qf6cz-ciaaa-aaaag-abtsq-cai in SNS-W to initiate the generation of an SNS for BOOM DAO"  \
   --summary "The proposal offers BOOM DAO's products to the NNS to be turned into decentralized infrastructure, protocols, and dapps by the creation of an SNS to govern BOOM DAO's canisters.
