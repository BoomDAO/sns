...
quill sns --canister-ids-file ./sns_canister_ids.json --pem-file $PEM_FILE make-proposal --proposal "(
    record {
        title = \"Transfer 5000 ICP to ICP/BOOM Pool on SONIC Dex\";
        url = \"https://boomdao.xyz/\";
        summary = \"This is the #1 of 2 proposals which will add liquidity to the [ICP/BOOM pool](https://data.sonic.ooo/pools/ryjl3-tyaaa-aaaaa-aaaba-cai:vtrom-gqaaa-aaaaq-aabia-cai) on SONIC DEX.
