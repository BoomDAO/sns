...
quill sns --canister-ids-file ./sns_canister_ids.json --pem-file $PEM_FILE make-proposal --proposal "(
    record {
        title = \"Transfer 3,850,400 BOOM to ICP/BOOM Pool on ICPSwap\";
        url = \"https://boomdao.xyz/\";
        summary = \"This is the #2 of 2 proposals which will transfer 3,850,400 BOOM to the ICP/BOOM pool on ICPSwap. 
...
\";
        action = opt variant {
            TransferSnsTreasuryFunds = record {
                ...
                memo = null;
                amount_e8s = 385040000000000 : nat64;
            }
        };
    }
